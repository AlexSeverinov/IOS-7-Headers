...
{
    id _helper;
    id <ABUnknownPersonViewController_LegacyDelegate> _unknownPersonViewDelegate;
    id _reserved;
...
@property(nonatomic) id <ABUnknownPersonViewController_LegacyDelegate> unknownPersonViewDelegate; // @synthesize unknownPersonViewDelegate=_unknownPersonViewDelegate;
