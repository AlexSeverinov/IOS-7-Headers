...
{
    id <ABNewPersonViewControllerDelegate_Legacy> _newPersonViewDelegate;
    id _parentGroup;
    id _helper;
...
@property(nonatomic) id <ABNewPersonViewControllerDelegate_Legacy> newPersonViewDelegate;
