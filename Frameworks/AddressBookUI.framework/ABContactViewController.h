...
@property(retain, nonatomic) NSArray *mutableContacts; // @synthesize mutableContacts=_mutableContacts;
...
@property(nonatomic) BOOL allowsAlerts; // @synthesize allowsAlerts=_allowsAlerts;
