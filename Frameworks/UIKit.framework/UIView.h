...
@class CALayer, NSArray, NSISVariable, NSMutableArray, NSMutableSet, NSString, UIColor, UIKBRenderConfig, UIViewController;
...
+ (void)performSystemAnimation:(unsigned int)arg1 onViews:(id)arg2 options:(unsigned int)arg3 animations:(id)arg4 completion:(void)arg5;
...
+ (void)_animateWithDuration:(double)arg1 delay:(double)arg2 options:(unsigned int)arg3 factory:(id)arg4 animations:(id)arg5 completion:(void)arg6;
...
+ (void)_setupAnimationWithDuration:(double)arg1 delay:(double)arg2 view:(id)arg3 options:(unsigned int)arg4 factory:(id)arg5 animations:(id)arg6 start:(void)arg7 animationStateGenerator:(id)arg8 completion:(void)arg9;
+ (void)addKeyframeWithRelativeStartTime:(double)arg1 relativeDuration:(double)arg2 animations:(id)arg3;
+ (void)animateKeyframesWithDuration:(double)arg1 delay:(double)arg2 options:(unsigned int)arg3 animations:(id)arg4 completion:(void)arg5;
+ (void)setAnimationTransition:(int)arg1 forView:(id)arg2;
+ (void)_animateUsingDefaultDampedSpringWithDelay:(double)arg1 initialSpringVelocity:(float)arg2 options:(unsigned int)arg3 animations:(id)arg4 completion:(void)arg5;
+ (void)_animateUsingSpringWithDuration:(double)arg1 delay:(double)arg2 options:(unsigned int)arg3 mass:(float)arg4 stiffness:(float)arg5 damping:(float)arg6 initialVelocity:(float)arg7 animations:(id)arg8 completion:(void)arg9;
...
- (struct CGRect)_visualAltitudeSensitiveBoundsWithInfiniteEdges:(int)arg1;
...
@property(nonatomic, getter=_monitorsAncestorGeometry, setter=_setMonitorsAncestorGeometry:) BOOL monitorsAncestorGeometry;
