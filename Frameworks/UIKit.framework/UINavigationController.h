...
@property(nonatomic, setter=_setIsUsingBuiltinAnimator:) BOOL _isUsingBuiltinAnimator; // @synthesize _isUsingBuiltinAnimator=__isUsingBuiltinAnimator;
...
- (struct CGRect)_visibleFrameForRightAuxViewWithStaticScrollBar:(id)arg1;
...
- (void)_positionTopBar:(id)arg1 hidden:(BOOL)arg2 edge:(int)arg3 center:(struct CGPoint)arg4 offset:(float)arg5;
- (void)_setNavigationBarHidesCompletelyOffscreen:(BOOL)arg1;
- (struct CGPoint)_computeTopBarCenter:(id)arg1 hidden:(BOOL)arg2 edge:(int)arg3 center:(struct CGPoint)arg4 offset:(float)arg5;
