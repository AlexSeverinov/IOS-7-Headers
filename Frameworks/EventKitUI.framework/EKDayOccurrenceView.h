...
+ (id)_stripedImageWithBaseColor:(id)arg1 stripeColor:(id)arg2;
...
+ (id)_cachedImageForCalendarColor:(id)arg1 declined:(BOOL)arg2 cancelled:(BOOL)arg3 tentative:(BOOL)arg4 needsReply:(BOOL)arg5 dayViewBackgroundStyle:(int)arg6;
