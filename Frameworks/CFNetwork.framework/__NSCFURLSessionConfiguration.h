...
@property(retain, getter=URLCredentialStoreage, setter=setURLCredentialStorage:) NSURLCredentialStorage *URLCredentialStorage; // @synthesize URLCredentialStorage=_URLCredentialStorage;
