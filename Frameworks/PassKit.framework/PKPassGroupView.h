...
@class NSMutableDictionary, PKGroup, PKPassView, PKReusablePassViewQueue, UILongPressGestureRecognizer, UIPageControl, UIPanGestureRecognizer, UIScrollView, _UIInterpolatingMotionEffect;
