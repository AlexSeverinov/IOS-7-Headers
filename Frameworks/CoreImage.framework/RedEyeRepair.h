...
- (CDStruct_28379a5f *)repairWithTag:(int)arg1;
...
- (BOOL)getDataProviderBytePtrWithImage:(struct CGImage *)arg1 into:(CDStruct_c3faddef *)arg2 width:(unsigned long)arg3 height:(unsigned long)arg4;
- (BOOL)getBlockSetWithImage:(struct CGImage *)arg1 into:(CDStruct_c3faddef *)arg2 width:(unsigned long)arg3 height:(unsigned long)arg4;
