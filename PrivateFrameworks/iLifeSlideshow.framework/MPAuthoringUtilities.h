...
+ (unsigned int)screenSizeFromOptions:(id)arg1;
...
+ (unsigned int)regionOfInterestPickModeFromOptions:(id)arg1;
+ (struct _NSRange)reconfigureRangeFromOptions:(id)arg1;
+ (id)layerTypeFromOptions:(id)arg1;
+ (unsigned int)presentationOrderFromOptions:(id)arg1;
...
+ (unsigned int)reorderModeFromOptions:(id)arg1;
...
+ (unsigned int)croppingModeForFitMoviesFromOptions:(id)arg1;
+ (unsigned int)croppingModeFromOptions:(id)arg1;
+ (unsigned int)audioScalingModeFromOptions:(id)arg1;
