...
- (void)forEachJunctionInRoad:(CDStruct_ffa11a62 *)arg1 visitor:(id)arg2;
- (void)forEachEdgeInRoad:(CDStruct_ffa11a62 *)arg1 visitTwice:(BOOL)arg2 visitor:(id)arg3;
...
- (BOOL)_readHiResBuildings:(CDStruct_b123d8da *)arg1;
