...
@property(nonatomic) BOOL useLabelParallax; // @synthesize useLabelParallax=_useLabelParallax;
...
@property(nonatomic) BOOL altitudeShowFlyoverDemarcation; // @synthesize altitudeShowFlyoverDemarcation=_altitudeShowFlyoverDemarcation;
