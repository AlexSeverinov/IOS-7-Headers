...
- (BOOL)reconcileSync:(unsigned int)arg1 withNewAnchor:(id)arg2 progressCallback:(id)arg3 error:(void)arg4;
- (BOOL)prepareForSyncWithHostAnchor:(id)arg1 progressCallback:(id)arg2 grappaID:(void)arg3 hostVersion:(unsigned long)arg4 error:(id)arg5;
