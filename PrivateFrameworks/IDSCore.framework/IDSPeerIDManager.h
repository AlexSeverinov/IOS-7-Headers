...
@interface IDSPeerIDManager : NSObject
{
    ...
    NSMutableDictionary *_purgeCompletionBlocks;
...
- (void)removePurgeCompletionBlockForToken:(id)arg1;
- (void)addPurgeCompletionBlock:(id)arg1 forToken:(void)arg2;
...
- (id)sessionTokenForURI:(id)arg1 pushToken:(id)arg2 fromURI:(id)arg3 service:(id)arg4;
...
- (void)_setPurgeTimerFromURI:(id)arg1 service:(id)arg2;
...
- (BOOL)_addCompletionBlock:(id)arg1 forURIs:(void)arg2 fromURI:(id)arg3 fromService:(id)arg4;
