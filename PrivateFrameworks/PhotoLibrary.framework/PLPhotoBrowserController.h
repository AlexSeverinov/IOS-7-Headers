...
@interface PLPhotoBrowserController : UIViewController <PLAirPlaySessionDataSource, PLAirPlayControllerDelegate, PLPublishingActivityDelegate, PLActivityViewControllerDelegate, PLDeletePhotosActionControllerDelegate, UIPageControllerDelegate, PLPhotoTileViewControllerDelegate, PLVideoViewDelegate, UIScrollViewDelegate, UINavigationControllerDelegate, UIAlertViewDelegate, UIActionSheetDelegate, PhotoScrubberDataSource, UIPopoverControllerDelegate, PLSlideshowSettingsViewControllerDelegate, PLSlideshowPluginDelegate, PLAirTunesServicePickerViewControllerDelegate, AirPlayRemoteSlideshowDelegate, PLDismissableViewController, PLAssetContainerObserver, PLAssetContainerListChangeObserver, PLAssetChangeObserver>
{
...
- (void)displayActivitySheetFromItem:(id)arg1 additionalActivities:(id)arg2 withConfigurationBlock:(id)arg3;
