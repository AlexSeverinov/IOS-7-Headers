...
@interface PLApplicationCameraViewController : PLCameraViewController <PLAssetContainerListChangeObserver, PLAssetContainerObserver, PLCameraPreviewWellImageChangeObserver, UINavigationControllerDelegate, PLPhotoBrowserControllerDelegate>
{
    ...
    struct CGRect __cameraViewFrameAtStartOfAutorotation;
    struct CGAffineTransform __cameraViewAutorotationTransform;
}

@property(readonly, nonatomic) struct CGRect _cameraViewFrameAtStartOfAutorotation; // @synthesize _cameraViewFrameAtStartOfAutorotation=__cameraViewFrameAtStartOfAutorotation;
@property(readonly, nonatomic) struct CGAffineTransform _cameraViewAutorotationTransform; // @synthesize _cameraViewAutorotationTransform=__cameraViewAutorotationTransform;
