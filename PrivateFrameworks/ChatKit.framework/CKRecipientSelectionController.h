...
@class ABPeoplePickerNavigationController, CKComposeRecipientView, CKRecipientSearchListController, CKScheduledUpdater, CRRecentContact, UIScrollView, _UINavigationControllerPalette;
...
@interface CKRecipientSelectionController : UIViewController <MFGroupDetailViewControllerDelegate, UINavigationControllerDelegate, MFComposeRecipientViewDelegate, CKRecipientSearchListControllerDelegate>
{
    ...
    CRRecentContact *_recentContactForPresentedABCard;
}

@property(nonatomic) BOOL preventAtomization; // @synthesize preventAtomization=_preventAtomization;
@property(retain, nonatomic) CRRecentContact *recentContactForPresentedABCard; // @synthesize recentContactForPresentedABCard=_recentContactForPresentedABCard;
...
- (float)_minimumKeyboardSizeForCurrentInterfaceOrientation;
...
- (void)_adjustToFieldPositionIfNecessary:(BOOL)arg1;
