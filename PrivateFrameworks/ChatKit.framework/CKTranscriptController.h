...
@interface CKTranscriptController : UIViewController <UIAlertViewDelegate, ABPeoplePickerNavigationControllerDelegate, CKTranscriptCollectionViewControllerDelegate, CKRecipientSelectionControllerDelegate, CKTranscriptHeaderControllerDelegate, CKTrimControllerDelegate, UIActionSheetDelegate, UIModalViewDelegate, ABPersonViewControllerDelegate, ABUnknownPersonViewControllerDelegate, UINavigationControllerDelegate, AFContextProvider, UIKeyInput, QLPreviewControllerDelegate, UIGestureRecognizerDelegate>
{
    ...
    CKTranscriptHeaderViewController *_transcriptHeaderViewController;
...
@property(retain, nonatomic) CKTranscriptHeaderViewController *transcriptHeaderViewController; // @synthesize transcriptHeaderViewController=_transcriptHeaderViewController;
...
- (void)_startEmailWithAddress:(id)arg1;
...
- (BOOL)entryField:(id)arg1 shouldInsertMediaObjects:(id)arg2;
...
- (void)_hideTranscriptHeaderViewAnimated:(BOOL)arg1;
